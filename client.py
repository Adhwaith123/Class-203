...
class GUI:
	...
	def layout(self,name):
		...
		self.textCons.place(relheight = 0.745,
							relwidth = 1,
							rely = 0.08)
        self.labelBottom=Label(self.Window,bg="#abp2b9",height=80)
		...
		self.buttonMessage=Button(self.labelBottom,text="Send",font="Helvetica bold",width=20,bg="#abb2b9",command=lambda:self.sendButton(self.enterMessage.get()))
